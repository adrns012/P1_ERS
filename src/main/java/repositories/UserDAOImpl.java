...
public class UserDAOImpl implements UserDAO {
    ...
    @Override
    public List<Reimbursement> listPastReimb(Integer userId) {
    ...
    @Override
    public List<Reimbursement> listAllReimb() {
        List<Reimbursement> reimbs = new ArrayList<>();
    ...
    @Override
    public void approve(Integer reimbId, Integer userId) {
        try (Connection conn = ConnectionUtil.getConnection()) {
    ...
    @Override
    public void deny(Integer reimbId, Integer userId) {
        try (Connection conn = ConnectionUtil.getConnection()) {
