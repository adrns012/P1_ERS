...
window.onload = async function () {
    let response = await fetch("http://localhost:9000/sessions")
    ...
    let greetingMessage = document.getElementById("dash")
    greetingMessage.innerText = "Hi there, " + user.firstName + "!"
